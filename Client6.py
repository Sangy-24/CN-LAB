    ...
    try:
        ...
        with open(file_name, 'rb') as f:
            ...
            while bytes_sent < file_size:
                ...
                print(f"Sent {len(bytes_data)} bytes, Total sent: {bytes_sent}/{file_size} bytes")

        # Send an "EOF" signal instead of an empty byte string for clarity
...
if __name__ == "__main__":
    # Replace '<Receiver_IP>' with the actual IP address of the receiving server
    server_address = ('<Receiver_IP>', 12345)
